...
<div class="container mb-4" style="width: 100%; max-width: 100%; padding: 0px; min-height: 600px">
    <div class="row mb-4">
        ...
        <div class="col-md-12 mb-2">
            ...
            <table class="table table-striped cms-data-table" data-source-api="<?php echo base_url('administrator/api/wraping/get_admin'); ?>">
                <thead>
                    <th>Image</th>
            ...
            <div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form method="post" action="<?php echo base_url('administrator/api/wraping/insert'); ?>" class="ajax-form" enctype="multipart/form-data">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Add Package Wraping</h5>
            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form method="post" action="<?php echo base_url('administrator/api/wraping/update'); ?>" class="ajax-form" enctype="multipart/form-data">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Edit Package Wraping</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
            ...
            <div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form method="post" action="<?php echo base_url('administrator/api/wraping/delete'); ?>" class="ajax-form" enctype="multipart/form-data">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Delete Pakcage Wraping</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
    ...
    $('.cms-data-table').dataTable({
        ...
        columns : [
            { data: 'image', className: 'text-center', render: function(data, type, row){
                html = '';
                if(data != '')
                    html = '<img src="' + '<?php echo base_url('public/uploads/wraping_type/'); ?>' + data + '"/>';
                return html;
            }},
            { data: 'name' },
        ...
        initComplete: function(settings, json) {
            $('.cms-btn-edit').click(function(e){
                ...
                $('#modalEdit form .image-preview').attr('src', '<?php echo base_url('public/uploads/wraping_type/'); ?>' + $(this).data('image'));
